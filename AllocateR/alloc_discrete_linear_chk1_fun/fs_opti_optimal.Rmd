...
title: |
  | Optimal Allocation
  | Conditional on Age, Income, Marital Status and Kids Count
...
slb_subtitle_stack_2nd = 'Showing 1st actual + 2nd round optimal (given 1st actual) '
slb_subtitle_joint_1st2nd = 'Optimal 2nd rounds (given 1st actual) '
```
...
st_img_suffix <- paste0(st_file_type_nospouse_shock, '_', st_img_suf_age_ybin, '_round1_optimal')
ls_pl_generic <- PrjOptiAlloc::ffp_snw_graph_optimal(ar_rho=ar_rho,
...
# Generate Graphs
st_img_suffix <- paste0(st_file_type_nospouse_shock, '_', st_img_suf_age_ybin, '_round1_optimal')
ls_pl <- PrjOptiAlloc::ffp_snw_graph_optimal(ar_rho=ar_rho,
                                df_input_il_noninc_covar=df_input_il_noninc_covar_zs0_1st,
                                df_alloc_i_long_covar_c=df_alloc_i_long_covar_c_zs0_1st,
                                df_alloc_i_long_covar_v=df_alloc_i_long_covar_v_zs0_1st,
...
```{r}
# Generic non feasible specific Figures
st_img_suffix <- paste0(st_file_type_withspouse_shock, '_', st_img_suf_age_ybin, '_round1_optimal')
ls_pl_generic <- PrjOptiAlloc::ffp_snw_graph_optimal(ar_rho=ar_rho,
...
st_img_suffix <- paste0(st_file_type_nospouse_shock, '_', st_img_suf_age_ybin, '_round2_optimal')
ls_pl_r2 <- PrjOptiAlloc::ffp_snw_graph_optimal(ar_rho=ar_rho,
...
df_alloc_i_long_covar_c_zs0_2nd_stack <- df_alloc_i_long_covar_c_zs0_2nd %>%
  ...
  rename(checks_optimal2nd = optimal,
         checks_actual = actual,
         checks_optimal = total) %>%
...
# Generate Graphs
stg_subtitle_stack=paste0(slb_subtitle_stack_2nd, stg_subtitle)
st_img_suffix <- paste0(st_file_type_nospouse_shock, '_', st_img_suf_age_ybin, '_round2_optimal_stack')
ls_pl_stack <- PrjOptiAlloc::ffp_snw_graph_optimal(ar_rho=ar_rho,
                                df_input_il_noninc_covar=df_input_il_noninc_covar_zs0_2nd,
...
st_img_suffix <- paste0(st_file_type_nospouse_shock, '_', st_img_suf_age_ybin, '_round2_optimal_joint')
ls_pl_joint <- PrjOptiAlloc::ffp_snw_graph_optimal(ar_rho=ar_rho,
                                df_input_il_noninc_covar=df_input_il_noninc_covar_zs0_2nd,
...
# Generate Graphs
stg_subtitle_stack=paste0(slb_subtitle_stack_2nd, stg_subtitle)
st_img_suffix <- paste0(st_file_type_withspouse_shock, '_', st_img_suf_age_ybin, '_round2_optimal')
ls_pl_r2 <- PrjOptiAlloc::ffp_snw_graph_optimal(ar_rho=ar_rho,
...
# Generate Graphs
stg_subtitle_stack=paste0(slb_subtitle_stack_2nd, stg_subtitle)
st_img_suffix <- paste0(st_file_type_withspouse_shock, '_', st_img_suf_age_ybin, '_round2_optimal_stack')
ls_pl_stack <- PrjOptiAlloc::ffp_snw_graph_optimal(ar_rho=ar_rho,
                                df_input_il_noninc_covar=df_input_il_noninc_covar_zs5_2nd,
...
# Generate Graphs
stg_subtitle_joint=paste0(slb_subtitle_joint_1st2nd, stg_subtitle)
st_img_suffix <- paste0(st_file_type_withspouse_shock, '_', st_img_suf_age_ybin, '_round2_optimal_joint')
ls_pl_joint <- PrjOptiAlloc::ffp_snw_graph_optimal(ar_rho=ar_rho,
                                df_input_il_noninc_covar=df_input_il_noninc_covar_zs5_2nd,
