# Feasible Allocation Graph, Figure In Appendix
# Feasible allocation doubling kids 1st round
# This is to generate the figure stored with path below:
# "Paper\Main_text_graphs_and_tables\Actual_vs_feasible_double_kids_C_allocation_by_income_kids_marital_status_round1.png"
...
srt_main_folder <- 'b1_a64_dblkid_18t64'
snm_sub_folder <- 'df_alloc_all_feasible_dblkid.csv'
st_img_name_full <- 'Actual_vs_feasible_double_kids_C_allocation_by_income_kids_marital_status_round1.png'
