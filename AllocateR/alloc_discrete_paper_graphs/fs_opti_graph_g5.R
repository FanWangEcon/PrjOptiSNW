# Four Group Optimal Allocation Graphs, Appendix Figure
# This is to generate the figure stored with path below:
# "Paper\Appendix_graphs_and_tables\Optimalg5_double_both_adults_and_kids_C_allocation_by_income_kids_marital_status_round1.png"
...
srt_main_folder <- 'b1_a64_dblbth_18t99'
snm_sub_folder <- 'df_alloc_all_optimalg4_dblbth.csv'
st_img_name_full <- 'Optimalg5_double_both_adults_and_kids_C_allocation_by_income_kids_marital_status_round1.png'
...
plt_cur <- plt_cur +
  scale_x_continuous(labels = x.labels, breaks = x.breaks,
                     limits = c(0, 180000/58056))

# Legend Labeling
# \u2013 allows for en-dash
ar_st_age_group_leg_labels <- c("18\u201330", "31\u201340", "41\u201350", "51\u201364", "65\u201399")
plt_cur <- plt_cur +
  theme(
