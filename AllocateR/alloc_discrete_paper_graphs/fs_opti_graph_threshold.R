...
srt_main_folder <- 'b1_a64_mulone_18t64'
snm_sub_folder <- 'df_alloc_all_feasible_mulone.csv'
st_img_name_full <- 'Actual_vs_threshold_C_allocation_by_income_kids_marital_status.png'
