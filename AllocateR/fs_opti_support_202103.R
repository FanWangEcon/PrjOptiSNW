fs_opti_support_202103 <- function(st_which_solu='snwx_trumpchk_moredense_a65zh266zs5_b1_xi0_manna_168_married',
  ...
  #' Similar to fs_opti_support_202103, but this runs the random perturbation exercses in a new set of folders. This has
  #' the functionalities of fs_opti_support_202103, supercededs that.
  #'
