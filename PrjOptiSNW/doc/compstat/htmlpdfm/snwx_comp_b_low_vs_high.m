...
% *PrjOptiSNW Package*>*.* This function solves for the V(states, unemployed) 
% assuming individuals suffer from unemployment spell, but with different UI (unemployment 
% benefits). Higher UI benefits leads to value/welfare and also higher consumption.  
...
% Shared xi value, 50 percent income loss. This is a one-time MIT shock that 
% changes choices today in the sense of changing the resource state-space, but 
% does not change forward expectations.
...
%% 
% Solve for $b=0.5$, 50 percent unemployment insurance, meaning 50 percent of 
% lost income is recovered.
...
% Find the deviation in value and consumption between higher and lower UI world. 
% Welfare is converted to units in fixed life-time consumption.
