%% 2019 (Biden/Trump Checks) Full States EV and EC of Two Checks
...
% *PrjOptiSNW Package*>*.* 2019 integrated over VU and VW, given optimal savings 
% choices, unemployment shocks and various expectations.
% 
% Given 2020 JAEEMK (age, endogenous savings, education, income shock, marital 
% status, kids count), what is the expected value for the planner given 2020 JAEEMK 
% and transition between 2019 to 2020 JAEEMK given some stimulus check assignment 
% based on 2019 information? (Stimulus amount set by WELF_CHECKS). This is similar 
% to <https://github.com/FanWangEcon/PrjOptiSNW/blob/master/PrjOptiSNW/splanneralt/snw_evuvw19_jaeemk.m 
% *snw_evuvw19_jaeemk*>, except the solution here, under <https://github.com/FanWangEcon/PrjOptiSNW/blob/master/PrjOptiSNW/splanneralt/snw_evuvw19_jaeemk_foc.m 
% *snw_evuvw19_jaeemk_foc*>, relies on First Order Conditions, and are hence faster.
% 
...
[ev19_jaeemk_check0, ec19_jaeemk_check0, ev20_jaeemk_check0, ec20_jaeemk_check0] = snw_evuvw19_jaeemk_foc(...
    ...
    V_emp_2020, ap_ss, cons_emp_2020, V_unemp_2020, cons_unemp_2020, mp_precompute_res);
% Call Function
welf_checks = 2;
