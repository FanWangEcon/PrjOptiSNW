function [Phi_true,Phi_adj,A_agg,Y_inc_agg,median_HH_income,it]=Aggregation(ap_ss,cons_ss,stat_distr_eta,stat_distr_educ,stat_distr_married,stat_distr_kids)
