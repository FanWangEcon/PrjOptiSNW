               ...
               for married=1:n_marriedgrid % Marital status
                   for kids=1:n_kidsgrid % Number of kids
                       ...
                       if j<n_jgrid
                           ...
                           amax=min(agrid(end),(1+r)*(agrid(a)+Bequests*(bequests_option-1))+epsilon(j,educ)*theta*exp(eta_H_grid(eta))*(xi+b*(1-xi))+SS(j,educ)+(married-1)*spouse_inc*exp(eta_S_grid(eta))*(xi+b*(1-xi))-max(0,Tax_COVID(inc,(married-1)*spouse_inc*exp(eta_S_grid(eta))*(xi+b*(1-xi)),a2_COVID)) );
                           ...
                           c_aux=consumption_tax(j,a,eta,educ,married,kids,ap_aux,a2_COVID,xi,b);
                           ...
                           c_aux3=consumption_tax(j,a,eta,educ,married,kids,0,a2_COVID,xi,b);
                       ...
                       elseif j==n_jgrid
                           ...
                           ap_VFI(j,a,eta,educ,married,kids)=0;
                           cons_VFI(j,a,eta,educ,married,kids)=consumption_tax(j,a,eta,educ,married,kids,ap_VFI(j,a,eta,educ,married,kids),a2_COVID,xi,b);
